...
Scriptname CheatBunker:Fragments:Terminals:SuppliesMedical Extends Terminal Hidden Const
...
;BEGIN CODE
Game.GetPlayer().AddItem(Stimpak, Paginator.iAmountToGive)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Game.GetPlayer().AddItem(RadX, Paginator.iAmountToGive)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Game.GetPlayer().AddItem(RadAway, Paginator.iAmountToGive)
;END CODE
EndFunction
;END FRAGMENT
