...
;BEGIN CODE
TransitHandler.CheatBunkerTransitQuest.SetStage(TransitHandler.InitiateSnapbackStage)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
TransitHandler.CheatBunkerTransitQuest.SetStage(TransitHandler.RecoverCompanionsStage)
;END CODE
EndFunction
;END FRAGMENT
